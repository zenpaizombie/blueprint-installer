...
- Automatic installation of the Blueprint Theme (everything).
...
```bash
bash <(curl -s https://raw.githubusercontent.com/zenpaizombie/blueprint-installer/refs/heads/main/install.sh)
```
