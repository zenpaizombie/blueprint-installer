...
[![Discord](https://img.shields.io/discord/1345325228363878432?label=&logo=discord&logoColor=ffffff&color=7389D8&labelColor=6A7EC2)](https://discord.gg/J5ecfWDY3u)
...
Unofficial scripts for installing Themes on Pterodactyl. Works with the latest version of Pterodactyl!

Read more about [Pterodactyl Panel](https://pterodactyl.io/) here. This script is not associated with the official Pterodactyl Project.

## Features

- Automatic installation of the Theme (everything).
...
List of supported installation setups for blueprint (installations supported by this installation script).


## Using the installation scripts

To use the installation scripts, simply run this command as root. The script will ask you whether you would like to install just the theme.

```bash
bash <(curl -s https://raw.githubusercontent.com/zenpaizombie/theme-installer/refs/heads/main/install.sh)
```
...
Copyright (C) 2025, ZenpaiZombie, <zenpaizombiewww@gmail.com>, and contributors!

- Created by [ZenpaiZombie](https://github.com/zenpaizombie)
